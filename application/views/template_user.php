...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?= base_url()?>asset/mfr.png" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Fani Rahmatulloh</div>
                    <div class="email">fanirahmatulloh842@gmail.com</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>    
                        <a href="<?= base_url('index.php/dashboard/profil')?>">
                            <i class="material-icons">account_circle</i>
                            <span>Profil</span>
                        </a>
                         <a href="<?= base_url('index.php/tentang/about')?>">
                            <i class="material-icons">attach_file</i>
                            <span>Nasi Goreng</span>
                        </a>
                        <a href="<?= base_url('index.php/tanggapan/masukan')?>">
                            <i class="material-icons">announcement</i>
                            <span>Saran</span>
                        </a>
                        <a href="<?= base_url('index.php/tabel_data/tabel')?>">
                            <i class="material-icons">panorama</i>
                            <span>Media</span>
                        </a>
                        <a href="<?= base_url('index.php/aplikasi/apps')?>">
